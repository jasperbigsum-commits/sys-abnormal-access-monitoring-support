...
public class MonitoringManagementController {
    ...
    public ManagementResult<SecurityEventView> event(@PathVariable("id") String id) {
        return ManagementResult.ok(events.get(actor(), id));
    }
    ...
    public ManagementResult<ControlView> control(@PathVariable("id") String id) {
        return ManagementResult.ok(controls.get(actor(), id));
    }
    ...
    public static final class VersionedReasonRequest {
        ...
        private java.time.Instant passExpiresAt;
