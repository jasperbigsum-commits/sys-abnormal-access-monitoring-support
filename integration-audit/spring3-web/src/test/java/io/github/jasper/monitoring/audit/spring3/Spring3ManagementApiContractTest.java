...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
    properties = "spring.datasource.url=jdbc:h2:mem:audit-spring3-api;MODE=MySQL;DB_CLOSE_DELAY=-1")
class Spring3ManagementApiContractTest {
    ...
    void eventsUsesJeecgEnvelopeAndPreservesZeroBasedPagination() {
        ResponseEntity<String> response = exchange(HttpMethod.GET, "/audit/management/events?page=0&size=1",
            "audit-admin", null);
    ...
    void falsePositivePathUsesJeecgEnvelope() {
        ...
        request.put("reason", "frontend false positive");
        request.put("idempotencyKey", "api-false-positive");
