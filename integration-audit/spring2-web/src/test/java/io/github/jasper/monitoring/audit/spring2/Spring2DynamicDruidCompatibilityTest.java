...
/** 验证监测 Starter 与 dynamic-datasource 的 Boot 2 Druid 多数据源装配兼容性。 */
@SpringBootTest(properties = {
    ...
    "spring.datasource.dynamic.datasource.monitoring.url=jdbc:h2:mem:audit-spring2-dynamic-monitoring;MODE=MySQL;DB_CLOSE_DELAY=-1",
    ...
    "spring.datasource.dynamic.datasource.business.url=jdbc:h2:mem:audit-spring2-dynamic-business;MODE=MySQL;DB_CLOSE_DELAY=-1",
...
class Spring2DynamicDruidCompatibilityTest {
