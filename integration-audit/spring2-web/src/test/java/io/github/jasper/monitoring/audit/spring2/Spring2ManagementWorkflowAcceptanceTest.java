...
class Spring2ManagementWorkflowAcceptanceTest {
    ...
    void tc12_whitelistSuppressesRuleOnlyWhileActiveAndUnexpired() {
        ...
        jdbc.update("INSERT INTO monitoring_security_whitelist(whitelist_id,system_id,rule_id,subject,reason,"
            ...
            "tc12", "audit-spring2-web", "AUTH-01", subjectKey, "predeclared", "fixture",
    ...
    void tc18_alertLifecycleIsVersionedAppendOnlyAndPermissionScoped() {
        ...
        assertEquals(HttpStatus.OK, acknowledged.getStatusCode());
        version++;
        ResponseEntity<String> assigned = postJson("/audit/management/alerts/" + alertId + "/assign",
            "audit-admin", alert(version, "investigate", "tc18-assign", "operator-a"));
