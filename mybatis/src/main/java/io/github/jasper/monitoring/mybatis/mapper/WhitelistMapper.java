...
public interface WhitelistMapper {
    ...
    @Insert("INSERT INTO monitoring_security_whitelist (whitelist_id, system_id, rule_id, subject, expires_at) VALUES (#{whitelistId}, #{systemId}, #{ruleId}, #{subject}, #{expiresAt})")
    int insert(@Param("whitelistId") String whitelistId, @Param("systemId") String systemId,
               @Param("ruleId") String ruleId, @Param("subject") String subject, @Param("expiresAt") Instant expiresAt);
}
