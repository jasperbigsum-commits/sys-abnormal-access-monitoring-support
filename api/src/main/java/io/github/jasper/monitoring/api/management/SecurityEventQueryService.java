...
public interface SecurityEventQueryService {
    ManagementPage<SecurityEventView> search(ManagementAuthorizer authorizer, ManagementActor actor, SecurityEventQuery query);
    SecurityEventView get(ManagementAuthorizer authorizer, ManagementActor actor, String eventId);
}
