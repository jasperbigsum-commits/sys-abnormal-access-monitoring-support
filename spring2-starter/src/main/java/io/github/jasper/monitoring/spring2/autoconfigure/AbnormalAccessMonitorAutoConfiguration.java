...
public class AbnormalAccessMonitorAutoConfiguration {
    ...
    static class MvcInstrumentationConfiguration {
        @Bean("abnormalAccessAnnotatedMonitoringAspect")
        @ConditionalOnMissingBean(AnnotatedMonitoringAspect.class)
        AnnotatedMonitoringAspect abnormalAccessAnnotatedMonitoringAspect(ListableBeanFactory beanFactory) {
            return new AnnotatedMonitoringAspect(beanFactory);
        }
    ...
    static class MvcMonitoringConfiguration {
        ...
        @Bean("abnormalAccessAnnotatedMonitoringInterceptor")
        @ConditionalOnMissingBean(AnnotatedMonitoringInterceptor.class)
        @ConditionalOnProperty(prefix = "abnormal.access.monitor.instrumentation", name = "enabled", havingValue = "true", matchIfMissing = true)
        AnnotatedMonitoringInterceptor abnormalAccessAnnotatedMonitoringInterceptor(ActionEventRecorder recorder,
                                                                                      TrustedProxyResolver trustedProxyResolver,
                                                                                      IdentityContextProvider identityContextProvider,
                                                                                      MdcTraceBridge mdcTraceBridge) {
            return new AnnotatedMonitoringInterceptor(recorder, trustedProxyResolver, identityContextProvider,
                mdcTraceBridge);
        }
        ...
        @Bean("abnormalAccessAnnotatedMonitoringWebMvcConfigurer")
        @ConditionalOnProperty(prefix = "abnormal.access.monitor.instrumentation", name = "enabled", havingValue = "true", matchIfMissing = true)
        org.springframework.web.servlet.config.annotation.WebMvcConfigurer abnormalAccessAnnotatedMonitoringWebMvcConfigurer(
            final AnnotatedMonitoringInterceptor interceptor) {
            return new org.springframework.web.servlet.config.annotation.WebMvcConfigurer() {
                @Override
                public void addInterceptors(org.springframework.web.servlet.config.annotation.InterceptorRegistry registry) {
