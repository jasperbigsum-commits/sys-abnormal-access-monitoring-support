...
class SecurityEventAssemblerTest {
    ...
    void writesApprovedBuiltInFactsToStandardEventFields() {
        ActionFacts facts = ActionFacts.builder().put(BuiltInFacts.ResourceId.class, "report-7")
            .put(BuiltInFacts.DataCount.class, 12L)
            .put(BuiltInFacts.Sensitivity.class, BuiltInFacts.SensitivityLevel.HIGH)
            .put(BuiltInFacts.SequentialAccess.class, Boolean.TRUE)
            .put(BuiltInFacts.TargetUserId.class, "target-7")
            .put(BuiltInFacts.PrivilegeIncrease.class, Boolean.FALSE)
            .put(BuiltInFacts.BaselineRatio.class, new BigDecimal("3.50")).build();
        ...
        assertEquals("3.5", result.getEvent().getAttribute("baseline_ratio"));
    }
