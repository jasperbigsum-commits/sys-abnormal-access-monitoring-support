...
public final class AnnotatedActionMonitoringAspect extends StaticMethodMatcherPointcutAdvisor
    ...
    public AnnotatedActionMonitoringAspect(ListableBeanFactory beanFactory) {
